...
%% All calculated values were obtained from 


%% Output folder
% saveROOT=[dataROOT '\Analysis\Unit_profiler\' date];
...
%     if       ~strcmp(summary(i_s).Region,'POR') 
...
%         [autocorrelogram,X_range,auto_conf_int]= Draw_correlogram(ClusterTS,ClusterTS,bin_size_sec,Xmin_sec, Xmax_sec,p_conf, ts_evt);
