%% Created by Jaerong 2018/06/13  for CR manuscript revision
...
function [summary,summary_header]=EEG_crosscorr(summary, summary_header,dataROOT)
...
%% Save folder
saveROOT= [dataROOT '\Analysis\EEG\CrossCorr\test' ];
