...
outputfile.FourOBJ=['Performance(FourOBJ_PerOBJ).csv'];
...
txt_header = 'RatID, Session, Task, Performance(All), Performance(Icecream), Performance(House), Performance(Owl), Performance(Phone), Performance(Push), Performance(Dig), Performance(Familiar), Performance(Novel) \n';
...
for i1=1:r1
    ...
    for i2=1:r2
        ...
        if strcmp(Task,'OCRS(FourOBJ)')
            ...
            fprintf(fod.FourOBJ,'%s ,%s ,%s, %1.3f, %1.3f, %1.3f, %1.3f, %1.3f, %1.3f, %1.3f, %1.3f, %1.3f, \n',  RatID, Task_session, Task, Performance.All, Performance.Stimulus1, Performance.Stimulus2, Performance.Stimulus3, Performance.Stimulus4, Performance.Pushing, Performance.Digging, Performance.Familiar, Performance.Novel);
            fclose(fod.FourOBJ);
